...
class ControllerModuleInvoiceFox extends Controller {
	...
	public function index() {   
		...
		$this->data['action'] = $this->url->link('module/invoicefpx', 'token=' . $this->session->data['token'], 'SSL');
		
		$this->data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');
				
		$this->data['modules'] = array();
		
		if (isset($this->request->post['invoicefox_module'])) {
			$this->data['modules'] = $this->request->post['invoicefox_module'];
		} elseif ($this->config->get('invoicefox_module')) { 
			$this->data['modules'] = $this->config->get('invoicefox_module');
		}
